...
class RVTest_rv64ui_p_auipc extends RVTest("rv64ui-p-auipc")
class RVTest_rv64ui_p_beq extends RVTest("rv64ui-p-beq")
class RVTest_rv64ui_p_bge extends RVTest("rv64ui-p-bge")
class RVTest_rv64ui_p_bgeu extends RVTest("rv64ui-p-bgeu")
class RVTest_rv64ui_p_blt extends RVTest("rv64ui-p-blt")
...
class RVTest_rv64ui_p_jal extends RVTest("rv64ui-p-jal")
class RVTest_rv64ui_p_jalr extends RVTest("rv64ui-p-jalr")
class RVTest_rv64ui_p_lb extends RVTest("rv64ui-p-lb")
class RVTest_rv64ui_p_lbu extends RVTest("rv64ui-p-lbu")
class RVTest_rv64ui_p_ld extends RVTest("rv64ui-p-ld")
class RVTest_rv64ui_p_lh extends RVTest("rv64ui-p-lh")
class RVTest_rv64ui_p_lhu extends RVTest("rv64ui-p-lhu")
class RVTest_rv64ui_p_lui extends RVTest("rv64ui-p-lui")
class RVTest_rv64ui_p_lw extends RVTest("rv64ui-p-lw")
class RVTest_rv64ui_p_lwu extends RVTest("rv64ui-p-lwu")
class RVTest_rv64ui_p_or extends RVTest("rv64ui-p-or")
class RVTest_rv64ui_p_ori extends RVTest("rv64ui-p-ori")
class RVTest_rv64ui_p_sb extends RVTest("rv64ui-p-sb")
class RVTest_rv64ui_p_sd extends RVTest("rv64ui-p-sd")
class RVTest_rv64ui_p_sh extends RVTest("rv64ui-p-sh")
...
class RVTest_rv64ui_p_sw extends RVTest("rv64ui-p-sw")
